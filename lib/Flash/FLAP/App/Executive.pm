...
use strict;
use Flash::FLAP::Util::RemotingService;
...
sub doMethodCall 
{
    ...
    {
        my $wrapper = new Flash::FLAP::Util::RemotingService($package, $object);
...
# was this defined in the methodTable -- required to enable FLAP service approach
